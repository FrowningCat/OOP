...
public class Main {
    public static void main(String[] args) {
        ...
        Comandor comandor = new Comandor("Vasia", 300, new LongBow());
        Team<Archer> archers = new Team<>(comandor);
        System.out.println(comandor);
        archers.addWarrior(new Archer("Vlad", 100, new LongBow()));
        archers.addWarrior(new Archer("Petr", 100, new LongBow()));
        ...
        System.out.println("\n" + "-------------------- новая команда --------------------");
        Comandor comandor1 = new Comandor("Oleg", 320, new LongBow());
        Team<Barbarian> barbarians = new Team<>(comandor1);
        System.out.println(comandor1);
        barbarians.addWarrior(new Barbarian("Sergy", 250, new Sekira()));
        ...
        System.out.println("\n" + "-------------------- новая команда --------------------");
        Comandor comandor2 = new Comandor("Dmitriy", 280, new LongBow());
        Team<Warrior> geng = new Team<>(comandor2);
        System.out.println(comandor2);
        geng.addWarrior(new Archer("Macha", 80, new LongBow()));
        geng.addWarrior(new Barbarian("Egor", 200, new Sekira()));
